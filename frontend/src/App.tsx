    ...
    <div className="h-screen w-screen flex overflow-hidden bg-gray-50">
      ...
      <div className="flex-[3] relative bg-white border-r border-gray-200">
        ...
        <div className="absolute top-0 left-0 p-5 pointer-events-none z-20">
          <h1 className="text-xl font-bold text-gray-100 flex items-center gap-2.5 tracking-tight drop-shadow-md">
            ...
            DodgeAI 
            <span className="font-light opacity-60 text-base">FDE</span>
          </h1>
        </div>
      </div>
